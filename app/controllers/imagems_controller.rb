class ImagemsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @imagem.save
        format.html { redirect_to @imagem, notice: 'A imagem foi criada com sucesso!' }
  ...
  def update
    respond_to do |format|
      if @imagem.update(imagem_params)
        format.html { redirect_to @imagem, notice: 'A imagem foi atualizada com sucesso!' }
  ...
  def destroy
    @imagem.destroy
    respond_to do |format|
      format.html { redirect_to imagems_url, notice: 'A imagem foi excluída com sucesso!' }
